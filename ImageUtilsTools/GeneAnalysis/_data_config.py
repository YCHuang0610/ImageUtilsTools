...
data = {
    ...
    "Glasser2016_rh_parc": os.path.join(DATA, "Glasser2016.R.32k_fs_LR.label.gii"),
    "Glasser2016_left_dist_mat_file": os.path.join(
        DATA, "LeftParcelGeodesicDistmat_Glasser2016_180regions.txt"
    ),
    "Glasser2016_right_dist_mat_file": os.path.join(
        DATA, "RightParcelGeodesicDistmat_Glasser2016_180regions.txt"
    ),
    "Glasser2016_AHBA_abagen_LR_noheader": os.path.join(
        DATA, "ahba_expression_Glasser2016LR_noHeader.csv"
    ),
    "Glasser2016_AHBA_gene_list": os.path.join(DATA, "genename_Glasser2016LR.csv"),
